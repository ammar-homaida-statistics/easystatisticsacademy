...
<section class="hero hero-section">
  <div class="hero-card hero-split">
    <div class="hero-copy">
      ...
      <p class="lead">
        Learn how statistical models represent relationships in data. Build correct understanding of
        regression, assumptions, diagnostics, model evaluation, and real interpretation—without shortcuts.
      </p>
    ...
    <div class="hero-panel">
      <div class="panel-card">
        ...
        <ol class="quickstart">
          <li><a href="#blocks">Modeling foundations</a><span class="meta">What models are, structure vs noise</span></li>
          <li><a href="#blocks">Simple regression</a><span class="meta">Slope, interpretation, basic assumptions</span></li>
          <li><a href="#blocks">Multiple regression</a><span class="meta">Adjusted effects, confounding</span></li>
          <li><a href="#blocks">Model assumptions</a><span class="meta">Linearity, independence, variance</span></li>
          <li><a href="#blocks">Diagnostics</a><span class="meta">Residuals, influence, validation</span></li>
          <li><a href="#blocks">Model evaluation</a><span class="meta">Fit, comparison, overfitting</span></li>
          <li><a href="#blocks">Extensions</a><span class="meta">Logistic regression, generalization</span></li>
        </ol>
      </div>
    </div>
  </div>
...
<section class="section section-slim">
  <div class="callout">
    <div class="callout-copy">
      ...
      <ul class="bullets">
        <li>Understand modeling as representation of relationships (not just equations)</li>
        <li>Interpret regression coefficients correctly</li>
        <li>Diagnose and validate model assumptions</li>
        <li>Evaluate models responsibly and avoid overfitting</li>
        <li>Prepare for Machine Learning</li>
      </ul>
    </div>
