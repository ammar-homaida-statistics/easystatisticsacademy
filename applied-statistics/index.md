...
<section class="hero">
  <div class="hero-card">
    <h1>Applied Statistics & Data Analysis</h1>
    <p>
      Real-world statistical analysis, surveys, experiments,
...
<section class="card">
  <h2>Topics</h2>
  <ul>
    <li>Survey analysis *(coming soon)*</li>
    <li>Experimental design *(coming soon)*</li>
    <li>Applied regression *(coming soon)*</li>
    <li>Case studies *(coming soon)*</li>
  </ul>
</section>
