...
description: "Check the assumptions behind confidence intervals: independence, random sampling, and normality/CLT. Learn what breaks when conditions fail."
  ...
  <div class="callout" style="background:#fff4e5; border:2px solid #ff9800; padding:2rem; border-radius:12px;">
    <div class="callout-copy">
      ...
      <p style="margin:0; font-size:1.05rem; color:#5d4037; line-height:1.6;">
        Version 0 locks the validity checklist. Diagnostics and fixes come later.
      </p>
    </div>
  </div>
</section>
...
<section class="hero hero-section">
  <div class="hero-card">
    <div class="hero-copy">
      ...
      <p class="lead">
        Confidence intervals require structural assumptions.
        This lesson defines the conditions and explains the consequences when they fail.
      </p>
      ...
      <p class="muted-mini">Version 0: checklist first.</p>
    </div>
  </div>
</section>
