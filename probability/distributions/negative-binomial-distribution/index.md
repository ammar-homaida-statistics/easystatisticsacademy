...
description: "Waiting time until r successes (or number of failures before r successes)."
  ...
  <div class="hero-card">
    <div class="hero-copy">
      <div class="badge-row">
        ...
        <span class="badge">NegBin</span>
      </div>

      <h1>4. Negative Binomial Distribution</h1>
      <p class="lead">Generalizes geometric: wait for r successes.</p>
