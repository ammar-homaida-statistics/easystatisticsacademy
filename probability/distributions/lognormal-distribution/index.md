...
description: "Positive skewed model: if log(X) is normal, then X is lognormal."
  ...
  <div class="callout" style="background:#fff4e5; border:2px solid #ff9800; padding:2rem; border-radius:12px;">
    <div class="callout-copy">
      ...
      <p style="margin:0; font-size:1.05rem; color:#5d4037; line-height:1.6;">
        Version 0 is published to lock structure. Examples, graphs, and software demos will be added later.
      </p>
    </div>
  </div>
</section>
  ...
  <div class="hero-card">
    <div class="hero-copy">
      <div class="badge-row">
        ...
        <span class="badge">Lognormal</span>
      </div>

      <h1>12. Lognormal Distribution</h1>
      <p class="lead">Models positive skew; multiplicative effects and growth.</p>
