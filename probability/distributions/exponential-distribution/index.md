...
description: "Waiting times with constant rate: Exponential(λ), memorylessness."
  ...
  <div class="hero-card">
    <div class="hero-copy">
      <div class="badge-row">
        ...
        <span class="badge">Exponential</span>
      </div>

      <h1>8. Exponential Distribution</h1>
      <p class="lead">Waiting time model with rate λ; memoryless property.</p>
