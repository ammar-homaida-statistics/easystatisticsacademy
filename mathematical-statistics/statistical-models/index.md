...
<section class="section" id="lessons">
  ...
  <div class="grid grid-2">
    ...
    <div class="card lesson-card">
      ...
      <div class="pill-row">
        <a class="btn btn-outline" href="/mathematical-statistics/statistical-models/what-is-a-statistical-model/"
    ...
    <div class="card lesson-card">
      ...
      <div class="pill-row">
        <a class="btn btn-outline" href="/mathematical-statistics/statistical-models/parameter-space-and-identifiability/"
           style="border-color:#111; color:#111;">Open lesson</a>
      </div>
    </div>
    ...
    <div class="card lesson-card">
      ...
      <div class="pill-row">
        <a class="btn btn-outline" href="/mathematical-statistics/statistical-models/iid-and-modeling-assumptions/"
           style="border-color:#111; color:#111;">Open lesson</a>
      </div>
    </div>
    ...
    <div class="card lesson-card">
      ...
      <div class="pill-row">
        <a class="btn btn-outline" href="/mathematical-statistics/statistical-models/examples-of-parametric-models/"
           style="border-color:#111; color:#111;">Open lesson</a>
      </div>
    </div>
    ...
    <div class="card lesson-card">
      ...
      <div class="pill-row">
        <a class="btn btn-outline" href="/mathematical-statistics/statistical-models/likelihood-preview-why-models-matter/"
           style="border-color:#111; color:#111;">Open lesson</a>
      </div>
    </div>
