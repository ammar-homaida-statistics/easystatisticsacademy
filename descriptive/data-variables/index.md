...
description: Conceptual foundations for descriptive statistics: what it means to describe data, units/variables, variable types, dataset structure, and measurement scales.
  ...
  <div class="hero-card hero-split">
    <div class="hero-copy">
      <div class="badge-row">
        ...
        <span class="badge">Conceptual clarity</span>
      ...
      <p class="lead">
        Conceptual clarity before numbers. This block prevents the most common beginner mistakes by defining
        what you are describing—units, variables, variable types, dataset structure, and measurement scales.
      </p>
